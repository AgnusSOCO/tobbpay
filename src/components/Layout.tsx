...
export default function Layout({ children, currentView, onViewChange }: LayoutProps) {
  ...
  const menuItems = [
    ...
    { id: 'transactions', label: 'Transacciones', icon: List, color: 'from-emerald-500 to-emerald-600' },
    { id: 'scheduled', label: 'Cargos Programados', icon: CreditCard, color: 'from-purple-500 to-purple-600' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">TOBB Pay</h1>
        </div>
        <button
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`
                      ...
                      ${isActive ? `bg-gradient-to-br ${item.color} shadow-lg` : 'bg-white bg-opacity-10'}
                    `}>
