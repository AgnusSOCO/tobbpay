...
export default function AIChatbot({ dashboardData }: AIChatbotProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: '¡Hola! Soy tu asistente de análisis de datos. Puedo ayudarte a entender tus métricas de pago, tendencias y responder preguntas sobre tus transacciones. ¿En qué puedo ayudarte?',
      timestamp: new Date(),
    },
  ]);
